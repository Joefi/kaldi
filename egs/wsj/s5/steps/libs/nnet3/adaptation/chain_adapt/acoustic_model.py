...
def train_new_models(dir, iter, srand, num_jobs,
                     ...
                     l2_regularize, xent_regularize, yent_regularize, leaky_hmm_coefficient,
    ...
    for job in range(1, num_jobs+1):
        ...
        thread = common_lib.background_command(
            """{command} {train_queue_opt} {dir}/log/train.{iter}.{job}.log \
                    nnet3-chain-adapt {parallel_train_opts} {verbose_opt} \
                    --apply-deriv-weights={app_deriv_wts} \
                    --l2-regularize={l2} --leaky-hmm-coefficient={leaky} \
                    {cache_io_opts}  --xent-regularize={xent_reg} --yent-regularize={yent_reg}\
                    {deriv_time_opts} \
                    ...
                    {dir}/{next_iter}.{job}.raw""".format(
                        ...
                        xent_reg=xent_regularize, yent_reg=yent_regularize, leaky=leaky_hmm_coefficient,
...
def train_one_iteration(dir, iter, srand, egs_dir,
                        ...
                        l2_regularize, xent_regularize, yent_regularize,
    ...
    compute_train_cv_probabilities(
        ...
        l2_regularize=l2_regularize, xent_regularize=xent_regularize, yent_regularize=yent_regularize,
...
def compute_train_cv_probabilities(dir, iter, egs_dir, l2_regularize,
                                   xent_regularize, yent_regularize, leaky_hmm_coefficient,
                                   run_opts,
                                   use_multitask_egs=False):
    ...
    common_lib.background_command(
        """{command} {dir}/log/compute_prob_valid.{iter}.log \
                nnet3-chain-adapt-compute-prob --l2-regularize={l2} \
                --leaky-hmm-coefficient={leaky} --xent-regularize={xent_reg} --yent-regularize={yent_reg} \
                {model} {dir}/den.fst \
        ...
        """.format(command=run_opts.command, dir=dir, iter=iter, model=model,
                   ...
                   xent_reg=xent_regularize, yent_reg=yent_regularize,
                   egs_dir=egs_dir,
                   multitask_egs_opts=multitask_egs_opts,
