...
import libs_adapt.nnet3.train.common as common_train_lib
import libs_adapt.common as common_lib
import libs_adapt.nnet3.train.chain_objf.acoustic_model as chain_lib
import libs_adapt.nnet3.report.log_parse as nnet3_log_parse
...
def get_args():
    ...
    parser.add_argument("--chain.l2-regularize", type=float,
                        ...
                        objective function.""")
    parser.add_argument("--chain.l2-adapt-regularize", type=float,
                        dest='l2_adapt_regularize', default=0.0,
                        help="""L2 adaptation regularization constant.""")
...
def train(args, run_opts):
    ...
    if (args.stage <= -6):
        ...
        shutil.copy('{0}/phone_lm.fst'.format(args.si_dir), args.dir)
    ...
    if (args.stage <= -5):
        ...
        shutil.copy('{0}/0.trans_mdl'.format(args.si_dir), args.dir)
        shutil.copy('{0}/den.fst'.format(args.si_dir), args.dir)
        shutil.copy('{0}/normalization.fst'.format(args.si_dir), args.dir)
    ...
    for iter in range(num_iters):
        ...
        if args.stage <= iter:
            ...
            chain_lib.train_one_iteration(
                ...
                l2_adapt_regularize=args.l2_adapt_regularize,
