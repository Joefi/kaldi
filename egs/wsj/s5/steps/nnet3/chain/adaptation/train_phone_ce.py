...
import libs.nnet3.adaptation.chain_adapt.acoustic_model as chain_lib
...
def get_args():
    ...
    parser.add_argument("--chain.yent-regularize", type=float,
                        dest='yent_regularize', default=0.0,
                        help="Weight of regularization function which is the "
                        "phone cross-entropy cost the outputs.")
    ...
    for iter in range(num_iters):
        ...
        if args.stage <= iter:
            ...
            chain_lib.train_one_iteration(
                ...
                yent_regularize=args.yent_regularize,
