...
namespace kaldi {
    namespace nnet3 {
        ...
        double ComputeObjf(bool batchnorm_test_mode, bool dropout_test_mode,
            ...
            NnetChainTSComputeProb* prob_computer) {
            if (batchnorm_test_mode || dropout_test_mode) {
                ...
                NnetChainTSComputeProb prob_computer_test(compute_prob_opts, chain_config,
                    den_fst, nnet_copy);
...
int main(int argc, char* argv[]) {
    try {
        ...
        NnetComputeProbOptions compute_prob_opts;
        NnetChainTSComputeProb prob_computer(compute_prob_opts, chain_config,
