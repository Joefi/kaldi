...
namespace kaldi {
    namespace nnet3 {
        ...
        NnetChainAdapter::NnetChainAdapter(const NnetChainAdaptationOptions& opts,
            const fst::StdVectorFst& den_fst,
            Nnet* nnet, Nnet* si_nnet) :
            opts_(opts),
        ...
        void NnetChainAdapter::TrainInternal(const NnetChainExample& eg,
            ...
            if (opts_.l2_adapt_regularize != 0) { 
                ApplyL2AdaptationRegularization(*nnet_, *delta_nnet_, opts_.l2_adapt_regularize, si_nnet_);
            }
        ...
        void NnetChainAdapter::ProcessOutputs(bool is_backstitch_step2,
            ...
            for (; iter != end; ++iter) {
                ...
                if (use_xent) {
                    ...
                    xent_objf = xent_objf * opts_.output_deriv_scale;
                ...
                nnet_output_deriv.Scale(opts_.output_deriv_scale);
               
                computer->AcceptInput(sup.name, &nnet_output_deriv);

                tot_objf = tot_objf * opts_.output_deriv_scale;
                tot_l2_term = tot_l2_term * opts_.output_deriv_scale;
                ...
                if (use_xent) {
                    xent_deriv.Scale(opts_.chain_config.xent_regularize * opts_.output_deriv_scale);
