...
#include "nnet3/nnet-chain-ts-training.h"
#include "nnet3/nnet-utils.h"

namespace kaldi {
    namespace nnet3 {

        NnetChainTSTrainer::NnetChainTSTrainer(const NnetChainTSTrainingOptions& opts,
        ...
        void NnetChainTSTrainer::Train(const NnetChainExample& chain_eg) {
            NVTX_RANGE(__func__);
        ...
        void NnetChainTSTrainer::TrainInternal(const NnetChainExample& eg,
        ...
        void NnetChainTSTrainer::TrainInternalBackstitch(const NnetChainExample& eg,
            const NnetComputation& computation,
        ...
        void NnetChainTSTrainer::ProcessOutputs(bool is_backstitch_step2,
            ...
            for (; iter != end; ++iter) {
                ...
                chain::ChainTSTrainingOptions chain_config(opts_.chain_config);
                {
        ...
        bool NnetChainTSTrainer::PrintTotalStats() const {
        ...
        NnetChainTSTrainer::~NnetChainTSTrainer() {
