...
#ifndef KALDI_NNET3_NNET_CHAIN_ADAPTING_DIAGNOSTICS_H_
#define KALDI_NNET3_NNET_CHAIN_ADAPTING_DIAGNOSTICS_H_
 ...
 */
class NnetChainAdaptComputeProb {
 public:
  // does not store a reference to 'config' but does store one to 'nnet'.
  NnetChainAdaptComputeProb(const NnetComputeProbOptions &nnet_config,
