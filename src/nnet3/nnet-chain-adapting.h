...
#ifndef KALDI_NNET3_NNET_CHAIN_ADAPTING_H_
#define KALDI_NNET3_NNET_CHAIN_ADAPTING_H_
...
struct NnetChainAdaptingOptions {
  NnetTrainerOptions nnet_config;
  chain::ChainAdaptingOptions chain_config;
  bool apply_deriv_weights;
  NnetChainAdaptingOptions(): apply_deriv_weights(true) { }
...
class NnetChainAdapter {
 public:
  NnetChainAdapter(const NnetChainAdaptingOptions &config,
 ...
 private:
  ...
  const NnetChainAdaptingOptions opts_;
