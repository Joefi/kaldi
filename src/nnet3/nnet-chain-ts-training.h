...
#ifndef KALDI_NNET3_NNET_CHAIN_TS_TRAINING_H_
#define KALDI_NNET3_NNET_CHAIN_TS_TRAINING_H_
...
namespace kaldi {
    namespace nnet3 {
        ...
        struct NnetChainTSTrainingOptions {
            NnetTrainerOptions nnet_config;
            chain::ChainTSTrainingOptions chain_config;
            bool apply_deriv_weights;
            NnetChainTSTrainingOptions() : apply_deriv_weights(true) { }
        ...
        /**
           ...
           model.
        */
        class NnetChainTSTrainer {
        public:
            NnetChainTSTrainer(const NnetChainTSTrainingOptions& config,
        ...
        private:
            ...
            const NnetChainTSTrainingOptions opts_;
