...
#ifndef KALDI_NNET3_NNET_CHAIN_ADAPT_TRAINING_H_
#define KALDI_NNET3_NNET_CHAIN_ADAPT_TRAINING_H_
...
namespace kaldi {
    namespace nnet3 {
        ...
        struct NnetChainAdaptationOptions {
            NnetTrainerOptions nnet_config;
            chain::ChainTrainingOptions chain_config;
            bool apply_deriv_weights;
            BaseFloat l2_adapt_regularize;
            BaseFloat output_deriv_scale;
            NnetChainAdaptationOptions() : apply_deriv_weights(true), l2_adapt_regularize(0.0), output_deriv_scale(1.0) { }
            ...
            void Register(OptionsItf* opts) {
                ...
                opts->Register("apply-deriv-weights", &apply_deriv_weights,
                    ...
                    "the example");
                opts->Register("l2-adapt-regularize", &l2_adapt_regularize, 
                    "Regularization constant for chain l2 adaptation");
                opts->Register("output-deriv-scale", &output_deriv_scale, "Scale the output and derivate");
            }
        };
        ...
        /**
           ...
           model.
        */
        class NnetChainAdapter {
        public:
            NnetChainAdapter(const NnetChainAdaptationOptions& config,
