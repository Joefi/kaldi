...
#include "chain/chain-adapting.h"
#include "chain/chain-kernels-ansi.h"
#include "chain/chain-adapt-numerator.h"
...
void ComputeChainObjfAndDerivE2e(const ChainAdaptingOptions &opts,
  ...
  *weight = supervision.weight * supervision.num_sequences *
  ...
  { // Doing the denominator first helps to reduce the maximum
    ...
    AdaptDenominatorComputation denominator(opts, den_graph,
  ...
  {
    GenericAdaptNumeratorComputation numerator(opts.numerator_opts,
...
void ComputeChainObjfAndDeriv(const ChainAdaptingOptions &opts,
  ...
  {
    AdaptNumeratorComputation numerator(supervision, nnet_output);
    // note: supervision.weight is included as a factor in the derivative from
    // the numerator object, as well as the returned logprob.
