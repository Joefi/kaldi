...
#ifndef KALDI_CHAIN_CHAIN_ADAPT_DENOMINATOR_H_
#define KALDI_CHAIN_CHAIN_ADAPT_DENOMINATOR_H_
...
// single HMM.
class AdaptDenominatorComputation {
 public:
  /*
  ...
  */
  AdaptDenominatorComputation(const ChainAdaptingOptions &opts,
 ...
 private:
  ...
  const ChainAdaptingOptions &opts_;
