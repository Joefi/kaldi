...
namespace kaldi {
    namespace chain {
        ...
        TSNumeratorComputation::TSNumeratorComputation(
        ...
        void TSNumeratorComputation::ComputeLookupIndexes() {
        ...
        BaseFloat TSNumeratorComputation::Forward() {
        ...
        void TSNumeratorComputation::Backward(
            BaseFloat weight,
