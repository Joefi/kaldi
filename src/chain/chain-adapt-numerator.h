...
#ifndef KALDI_CHAIN_CHAIN_ADAPT_NUMERATOR_H_
#define KALDI_CHAIN_CHAIN_ADAPT_NUMERATOR_H_
...
class AdaptNumeratorComputation {
 ...
 public:
  ...
  AdaptNumeratorComputation(const Supervision &supervision,
