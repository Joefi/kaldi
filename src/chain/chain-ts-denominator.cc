...
#include "chain/chain-ts-denominator.h"
...
namespace kaldi {
    namespace chain {
        ...
        TSDenominatorComputation::TSDenominatorComputation(
            const ChainTSTrainingOptions& opts,
        ...
        void TSDenominatorComputation::AlphaFirstFrame() {
        ...
        void TSDenominatorComputation::AlphaGeneralFrame(int32 t) {
            NVTX_RANGE(__func__);
        ...
        void TSDenominatorComputation::AlphaDash(int32 t) {
            NVTX_RANGE(__func__);
            BaseFloat* this_alpha = alpha_.RowData(t);
        ...
        void TSDenominatorComputation::Beta(int32 t) {
            NVTX_RANGE(__func__);
        ...
        BaseFloat TSDenominatorComputation::Forward() {
            NVTX_RANGE(__func__);
            AlphaFirstFrame();
            AlphaDash(0);
        ...
        BaseFloat TSDenominatorComputation::ComputeTotLogLike() {
            NVTX_RANGE(__func__);
        ...
        bool TSDenominatorComputation::Backward(
        ...
        void TSDenominatorComputation::BetaDashLastFrame() {
        ...
        void TSDenominatorComputation::BetaDashGeneralFrame(int32 t) {
            NVTX_RANGE(__func__);
            KALDI_ASSERT(t >= 0 && t < frames_per_sequence_);
            int32 num_pdfs = exp_nnet_output_transposed_.NumRows();
        ...
        void TSDenominatorComputation::BetaGeneralFrameDebug(int32 t) {
