...
#ifndef KALDI_CHAIN_CHAIN_TS_DENOMINATOR_H_
#define KALDI_CHAIN_CHAIN_TS_DENOMINATOR_H_
...
namespace kaldi {
    namespace chain {
         ...
         */
         ...
         // single HMM.
        class TSDenominatorComputation {
        public:
            /*
            ...
            */
            TSDenominatorComputation(const ChainTSTrainingOptions& opts,
        ...
        private:
            ...
            const ChainTSTrainingOptions& opts_;
