...
AdaptNumeratorComputation::AdaptNumeratorComputation(
...
void AdaptNumeratorComputation::ComputeLookupIndexes() {
...
BaseFloat AdaptNumeratorComputation::Forward() {
...
void AdaptNumeratorComputation::Backward(
