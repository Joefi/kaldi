...
#ifndef KALDI_CHAIN_CHAIN_TS_NUMERATOR_H_
#define KALDI_CHAIN_CHAIN_TS_NUMERATOR_H_
...
namespace kaldi {
    namespace chain {
        ...
        public:
            ...
            TSNumeratorComputation(const Supervision& supervision,
